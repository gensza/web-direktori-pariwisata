<div class="hero-wrap js-fullheight" style="background-image: url('assets/images/home/home-34.jpg');">
                    ...
                    <div class="col-md-12 ftco-animate">
                        <div class="destination">
                            ...
                            <div class="text p-3">
                                <div class="d-flex">
                                    <div class="one">
                                        <h3><a href="<?= base_url('hotel_single'); ?>">Nama Akomodasi</a></h3>
                                        <p class="rate">
                                ...
                                <p class="bottom-area d-flex">
                                    ...
                                    <a href="<?= base_url('jasa_akomodasi'); ?>" class="btn-first-2 float-left">DTW Sekitar</a>
